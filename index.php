...
<body>
			...
			<div class="container" style="opacity: 1;">
				<div class="w-layout-grid hero-grid">
					<div class="text-box _600">
						...
						<a href="workspace/" class="btn_try button w-button">Попробовать</a>
					</div>
					<img src="Bot_logo.png" loading="eager" width="337" id="w-node-_2c511369-eabb-a0ff-6024-6e8ecffbdf82-427e4465" alt="" class="hero-illustration">
				</div>
			</div>
		</div>
		<footer>
	...
	<form action="" class="login_form modal" id="reg-form" style="display:none;">
		...
		<div class="text-field text-field_floating-2">
			<input class="text-field__input" type="email" id="reg_login" name="reg_mail" placeholder="Логин">
			<label class="text-field__label" for="reg_mail">Логин</label>
		</div>
		<div class="text-field text-field_floating-2">
	...
	<form action="" class="login_form modal" id="reg-notice-form" style="display:none;">
